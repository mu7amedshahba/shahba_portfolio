...
const Projects = () => {
  ...
  const categories = ["All", "Fullstack", "Web App", "Mobile", "AI/ML", "FinTech"];
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 relative z-10">
        ...
        <div className="flex flex-wrap justify-center gap-3 mb-12">
          {categories.map((category, index) => (
            <button
              key={index}
              className="px-6 py-3 rounded-full bg-white/10 backdrop-blur-sm border border-white/20 text-white font-medium hover:bg-orange-500/30 hover:border-orange-400 transition-all duration-300 hover:scale-105"
            >
              {category}
            </button>
          ))}
              ...
              <div className="p-6">
                ...
                <div className="flex items-center justify-between pt-4 border-t border-white/20">
                  ...
                  <div className="flex gap-3">
                    <button className="p-2 bg-white/10 rounded-lg border border-white/20 hover:bg-orange-500/30 hover:border-orange-400 transition-all duration-300">
                      <svg className="w-4 h-4 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                        <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M10 6H6a2 2 0 00-2 2v10a2 2 0 002 2h10a2 2 0 002-2v-4M14 4h6m0 0v6m0-6L10 14" />
                      </svg>
                    </button>
                    <button className="p-2 bg-white/10 rounded-lg border border-white/20 hover:bg-blue-500/30 hover:border-blue-400 transition-all duration-300">
