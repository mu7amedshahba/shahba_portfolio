...
const Projects = () => {
  ...
  const projects = [
    ...
    },
    {
      ...
      description: "AI-powered content creation platform with GPT integration and automated publishing.",
    ...
    },
    {
      ...
      description: "Cryptocurrency portfolio tracker with real-time market data and trading analytics.",
  ...
  const categories = ['All', 'Fullstack', 'Web App', 'AI/ML', 'Mobile', 'Finance'];
  ...
  return (
    <section id="projects" className="py-12 md:py-20 lg:py-28 bg-white dark:bg-gray-950 scroll-mt-20 relative overflow-hidden" ref={ref}>
      {/* Background Elements */}
        ...
        >
          ...
          >
            ...
            >
              ...
              />
              <span className="text-sm font-medium text-orange-700 dark:text-orange-300">Portfolio</span>
            </motion.div>
            ...
            <motion.h2 
              ...
              variants={itemVariants}
            >
              Featured <span className="text-orange-500 dark:text-orange-400">Projects</span>
            </motion.h2>
              ...
              {filteredProjects.map((project) => (
                ...
                >
                  ...
                  <div className="relative h-48 sm:h-56 overflow-hidden">
                    <motion.div 
                      className="w-full h-full bg-gradient-to-br from-orange-500/10 via-purple-500/10 to-blue-500/10 group-hover:from-orange-500/20 group-hover:via-purple-500/20 group-hover:to-blue-500/20"
          ...
          >
            <div className="bg-gray-50 dark:bg-gray-800 rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-700 max-w-2xl mx-auto">
              ...
              <motion.p 
                ...
                variants={itemVariants}
              >
                Explore my complete portfolio with detailed case studies and live demos.
              </motion.p>
              <motion.a
                href="/projects"
