        ...
        >
          ...
          >
            ...
            <motion.p
              ...
              variants={itemVariants}
            >
              End-to-end consulting and development services tailored to
              transform your business operations, from strategic planning to
              ...
              >
                {servicesData.map((category, index) => (
                  <option
                    key={index}
                    value={index}
                    className="bg-white dark:bg-gray-900 text-gray-900 dark:text-white text-xl"
                  >
        ...
        {category.items.length}
            ...
            <div className="lg:w-2/3 xl:w-3/4">
              <AnimatePresence mode="wait">
                ...
                >
                  <motion.div
                    className="bg-white dark:bg-gray-900 text-center  rounded-2xl p-6 md:p-8 border border-gray-200 dark:border-gray-800 shadow-xl"
                  ...
                  >
                    ...
                    >
                      ...
                      <div className="flex-1 min-w-0">
                        <h3 className="text-xxl md:text-2xl lg:text-3xl font-bold text-gray-900 dark:text-white mb-1">
                          {servicesData[activeCategory].category}
                        </h3>
                        <p className="text-gray-600 dark:text-gray-400 text-sm md:text-base">
                          {servicesData[activeCategory].items.length}{" "}
                    ...
                    <motion.div
                      ...
                      variants={containerVariants}
                    >
                      {servicesData[activeCategory].items.map(
                        (service, index) => (
                          <motion.div
                            key={index}
                          ...
                          >
                            <div className="flex items-start gap-3 md:gap-4">
                              ...
                              >
                                <span className="text-orange-500 dark:text-orange-400 text-sm md:text-lg">
                                  ✓
                                </span>
                              </motion.div>
                              <div className="flex-1 min-w-0">
                    ...
                    >
                      <div className="grid grid-cols-2 gap-4 md:flex md:flex-wrap md:justify-between text-center">
                        {[
                          {
                            value: servicesData[activeCategory].items.length,
                            label: "Services",
                          },
          ...
          >
            <div className="bg-white dark:bg-gray-900 rounded-2xl p-6 md:p-8 lg:p-12 border border-gray-200 dark:border-gray-800 shadow-xl max-w-4xl mx-auto">
              ...
              <motion.p
                ...
                variants={itemVariants}
              >
                Let's discuss how my comprehensive consulting and development
                services can drive growth, efficiency, and innovation for your
                organization.
              </motion.p>
              <motion.div
